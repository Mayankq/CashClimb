...
import Login from './login.js'; // Corrected import path
...
import './App.css';
import AccountSettings from './accountset.js';
import MyForm from './loanapp.js';
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/accountset" element={<AccountSettings/>}/>
          <Route path="/loanapp" element={<MyForm/>}/>
        </Routes>
      </div>
    </Router>
  );
